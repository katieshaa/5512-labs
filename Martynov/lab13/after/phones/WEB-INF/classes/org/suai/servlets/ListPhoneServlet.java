...
public class ListPhoneServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/phones/list-phones/finder":
		    String whoFind = request.getParameter("finder");
		    out.println(generateFindResult(whoFind));
		    
		    break;

                default:
                    out.println("Nothing here!");
                    out.println("<a href=\"/phones/list-phones/form\">Add</a>\n");
            }
    ...
    private String generateFinder(){
	StringBuilder builder = new StringBuilder();

	builder.append("<form method=\"GET\" action=\"/phones/list-phones/finder\">");
	builder.append("Finder: <input type=\"text\" name=\"finder\">");
        builder.append("<input type=\"submit\" value=\"Find\">");
        builder.append("</form>");
        builder.append("<br/>");
        builder.append("<br/>");
    ...
    private String generateFindResult(String whoFind) {
	StringBuilder builder = new StringBuilder();
	
	ArrayList<String> numbers = phoneBook.get(whoFind);
	if(numbers != null) {
        	builder.append("<p>").append(whoFind).append("</p>");
	
		builder.append("<ul style=\"list-style=type:circle\">");
            	for (String i : numbers) {
                	builder.append("<li>").append(i).append("</li>");
            	}
            	builder.append("</ul>");
	}
	else {
		builder.append("<p>Nothing find!</p>");
	}

	builder.append("<a href=\"/phones/list-phones\">Back to list</a>");
