...
Добавить ссылку “удалить” под свои объявления. Для не своих (не созданных текущим пользователем) ссылка не выводится. Удалять могут только вошедшие в систему пользователи.
