...
Добавить ссылку "ответить на объявление" под каждое объявление. Ответы выводятся под объявлением со смещением вправо. Отвечать на ответ нельзя.
Отвечать могут только вошедшие в систему пользователи.
