...
public class ListServlet extends HttpServlet implements Pathways, HTMLConstants {
	...
	private String arrayToHTML(ArrayList<ArrayList<String>> list) {
		...
		builder.append(getButtonViewHTML("Add view"));
	...
	private String getButtonViewHTML(String text) {
		StringBuilder builder = new StringBuilder();

		builder.append("<div class='").append(CHANGER_VIEW_CLASS).append("'>");

		builder.append("<a onclick='").append(ONCLICK_EXTRA_LIST)
			   .append("' href='#'>");
		builder.append(text);
		builder.append("</a>");
	...
	private String generateDropdownHTML(ArrayList<String> list) {
		...
		builder.append("<a class='").append(DROPDOWN_MANAGER_CLASS)
			   .append("' onclick='").append(ONCLICK_SHOW_DROPDOWN_LIST)
			   .append("' href='#'>");
		builder.append("[+]");
		builder.append("</a>");
