...
Дополнительное задание 
 Добавить форму для удаления элементов из списков. При удалении элемента в отдельных полях указывается: номер списка первого уровня и название удаляемого пункта. Если указан номер списка первого уровня 0, то удаляется элемент первого уровня. Реализовать с помощью js проверку, что список, из которого добавляется пункт, существует.