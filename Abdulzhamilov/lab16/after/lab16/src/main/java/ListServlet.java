...
private int count = 1;
    ...
    public void delete(int level,String name)
    {
        ...
        if (level ==0)
        {
            for(int i = 0;i <  arrayList.size();i++)
            {
                if( arrayList.get(i).get(0).equals(name))
                {
                    arrayList.remove(i);
                }
            }
        ...
        {
            {
                for(int i = 0;i <  arrayList.get(level - 1).size();i++)
                {
                    if( arrayList.get(level - 1).get(i).equals(name))
                    {
                        arrayList.get(level - 1).remove(i);
                    }
                }
            }
        }
