                    ...
                    while (true) {
                        ...
                        for (int i = 0; i < size; i++) {
                            ...
                            if (connection.isNewMessage()) {
                                ...
                                if (message.getMessageType().equals("alarm")) {
                                    Timer timer = new Timer();
                                    TimerTask timerTask = new AlarmTask(connection.getObjectOutputStream());
                                    String seconds = message.getMsg().substring(7);
                                    timer.schedule(timerTask, Integer.parseInt(seconds) * 1000);
                                    continue;
                                }
